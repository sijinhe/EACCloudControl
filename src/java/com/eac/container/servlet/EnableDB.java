 ...
 * @author Sijin
 */
public class EnableDB extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(container != null){
                json = jc.createJSON(container, true, "Enable DB [DB Insertion Success]");
            } else {
                json = jc.createJSON(container, false, "Enable DB [DB Insertion Failed]");
            }
