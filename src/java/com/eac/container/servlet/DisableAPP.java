 ...
 * @author Sijin
 */
public class DisableAPP extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            container = aact.disableAPP(container);

            JSONContainer jc = new JSONContainer();

            if(container != null){
                json = jc.createJSON(container, true, "Disable APP [DB Insertion Success]");
            } else {
                json = jc.createJSON(container, false, "Disable APP [DB Insertion Failed]");
            }
