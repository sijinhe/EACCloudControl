 ...
 * @author Sijin
 */
public class EnableAPP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            container = aact.enableAPP(container);

            JSONContainer jc = new JSONContainer();

            if(container != null){
                json = jc.createJSON(container, true, "Enable APP [DB Insertion Success]");
            } else {
                json = jc.createJSON(container, false, "Enable APP [DB Insertion Failed]");
            }
