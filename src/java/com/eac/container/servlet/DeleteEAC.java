 ...
 * @author Sijin
 */
public class DeleteEAC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cact.checkContainerDeletable(container)) {
                container = cact.deleteContainer(container);

                if (container != null) {
                    json = jc.createJSON(container, true, "Delete EAC [DB Insertion Success]");
                } else {
                    json = jc.createJSON(container, false, "Delete EAC [DB Insertion Failed]");
                }

            } else {

                json = jc.createJSON(container, false, "Delete EAC [Illegal to delete]");
            }
