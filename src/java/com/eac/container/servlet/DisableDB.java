 ...
 * @author Sijin
 */
public class DisableDB extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(container != null){
                json = jc.createJSON(container, true, "Disable DB [DB Insertion Success]");
            } else {
                json = jc.createJSON(container, false, "Disable DB [DB Insertion Failed]");
            }
