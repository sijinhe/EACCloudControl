 ...
 * @author Sijin
 */
public class ChangeInstanceNo extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String inst = request.getParameter("instance");

            ContainerAction ca = new ContainerAction();

            String json = "";

            JSONContainer jc = new JSONContainer();

            if (ca.changeInstance(containerid, inst)) {
